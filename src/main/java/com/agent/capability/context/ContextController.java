...
public class ContextController {
    ...
    private static final String SYSTEM = "你是企业级智能体助手。依据提供的知识库上下文与用户记忆作答，仅基于给出信息，不臆造；涉及敏感/政策问题低置信时提示转人工。";

    private final ContextAssembler assembler;
    private final MemoryService memory;

    public ContextController(ContextAssembler assembler, MemoryService memory) {
